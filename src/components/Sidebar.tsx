...
const Sidebar = () => {
  ...
  return (
    <div style={toggle ? expandedSidebarStyle : collapsedSidebarStyle} className="h-full px-3 pb-4 overflow-y-auto bg-white">
      <ul className="space-y-2 font-medium">
        ...
        {menus.map((menu, index) => (
          <li key={index}>
            <a
              href={menu.url}
              className={`flex items-center p-2 text-black rounded-lg hover:bg-blue-400 hover:text-white group space-x-3 ${pathName === menu.url
